#ifndef KCUCKOOUNTER_TESTS_INCLUDE_RASTERIZATION_RUNNER_TESTS_HPP
#define KCUCKOOUNTER_TESTS_INCLUDE_RASTERIZATION_RUNNER_TESTS_HPP
...
#endif // KCUCKOOUNTER_TESTS_INCLUDE_RASTERIZATION_RUNNER_TESTS_HPP
