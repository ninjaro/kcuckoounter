#ifndef KCUCKOOUNTER_TESTS_INCLUDE_INFINITY_SPINBOX_TESTS_HPP
#define KCUCKOOUNTER_TESTS_INCLUDE_INFINITY_SPINBOX_TESTS_HPP
#include <QObject>
...
#endif // KCUCKOOUNTER_TESTS_INCLUDE_INFINITY_SPINBOX_TESTS_HPP
