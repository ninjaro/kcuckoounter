#ifndef KCUCKOOUNTER_TESTS_INCLUDE_RASTER_CACHE_TESTS_HPP
#define KCUCKOOUNTER_TESTS_INCLUDE_RASTER_CACHE_TESTS_HPP
...
#endif // KCUCKOOUNTER_TESTS_INCLUDE_RASTER_CACHE_TESTS_HPP
