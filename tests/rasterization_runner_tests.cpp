...
constexpr int k_min_short_px = 63;
constexpr double k_overscan = 1.75;
constexpr double k_bucket_k = 1.12;

int bucketize(int short_px) {
...
int expected_target(int need_px) {
