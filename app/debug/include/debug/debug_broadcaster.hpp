#ifndef KCUCKOOUNTER_MONITOR_DEBUG_BROADCASTER_HPP
#define KCUCKOOUNTER_MONITOR_DEBUG_BROADCASTER_HPP
...
public:
    ...
    static QString
    endpoint_path_for_requested_name(const QString& requested_endpoint_name);
...
private:
    ...
    [[nodiscard]] static bool compile_time_enabled();
...
#endif // KCUCKOOUNTER_MONITOR_DEBUG_BROADCASTER_HPP
