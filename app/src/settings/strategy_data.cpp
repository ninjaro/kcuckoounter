...
static QMap<QString, double> parse_metrics(const QJsonObject& metrics_object) {
...
static QVector<int> parse_weights(const QJsonArray& weights_array) {
    QVector<int> weights;
...
parse_unique_fields(const QJsonObject& unique_object) {
...
static QVector<strategy_data::strategy_reference>
...
static QMap<QString, QString> parse_key_descriptions(const QJsonObject& root) {
