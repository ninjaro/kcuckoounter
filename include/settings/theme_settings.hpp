#ifndef KCUCKOOUNTER_INCLUDE_SETTINGS_THEME_SETTINGS_HPP
#define KCUCKOOUNTER_INCLUDE_SETTINGS_THEME_SETTINGS_HPP
...
#endif // KCUCKOOUNTER_INCLUDE_SETTINGS_THEME_SETTINGS_HPP
