#ifndef KCUCKOOUNTER_INCLUDE_ARCH_TIME_INTERFACE_HPP
#define KCUCKOOUNTER_INCLUDE_ARCH_TIME_INTERFACE_HPP
...
#endif // KCUCKOOUNTER_INCLUDE_ARCH_TIME_INTERFACE_HPP
